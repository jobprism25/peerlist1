          ...
          >
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center">
                  <span className="max-w-fit ">
                    <a className="flex items-center" href="/lunin">
                        ...
                        <div className="w-10 h-10 relative">
                          ...
                          <div className="w-10 h-10 rounded-full overflow-hidden ">
                            <img
                              ...
                              src="https://dqy38fnwh4fqs.cloudfront.net/UH8O96P8GROR8DKHRQEOBNDBABJ9/h8o96p8gror8dkhrqeobndbabj9-profile.webp"
                              alt="Dmitrii Lunin"
                              width={40}
                              height={40}
                            />
                    ...
                    <div className="text-gray-500 text-xs leading-4">
                      <div className="flex items-center flex-wrap">
                        ...
                        <span className="inline-flex items-center">
                          <a className="hover:underline" href="/scroll/ask">
                            #ask
                          </a>{" "}
                        </span>
                        &nbsp;•&nbsp;<span>4h </span>
            ...
            <div className="ml-12">
              <p className="text-gray-1k font-semibold text-sm mb-2 text-sm">
                Mass Outreach vs. Targeted Approach: What’s the Best Way to
              ...
              <div>
                <div className="break-words text-gray-1k post-caption font-normal rich-text-paragraph-regular text-sm mb-2">
                  <p className="">
                    I am currently preparing to approach potential investors for
                    our pre-seed round and am considering two approaches:
                  </p>
                  <br />
                  <p className="">
                    The first is a mass outreach strategy targeting a list of
                    10,000 contacts that has been meticulously compiled over the
                    years. This approach maximises reach, but it lacks
                    personalisation.
                    <span
                      className="text-green-300 !font-normal hover:underline cursor-pointer ml-0.5"
                      data-read="read-more"
                    >
                      Read More
                    </span>
            ...
            <div className="w-full pl-12">
                  ...
                  >
                      ...
                      <div className="lf-player-container">
                        ...
                        >
                          ...
                          >
                            ...
                            <g clipPath="url(#__lottie_element_537)">
                              <g
                    ...
                    <span className="tabular-nums">
                      <number-flow-react
                        aria-label={3}
                        role="img"
                        data='{"pre":[],"integer":[{"type":"integer","value":3,"key":"integer:0","pos":0}],"fraction":[],"post":[],"valueAsString":"3","value":3}'
                      />
                    </span>
                  </button>
                  <div role="none">
                  ...
                  >
                      ...
                      <div className="lf-player-container">
                        ...
                        >
                          ...
                          >
                            ...
                            <g clipPath="url(#__lottie_element_552)">
                              <g
                                style={{ display: "block" }}
                              ...
                              >
                                <g>
                                  <path fill="url(#__lottie_element_576)" />
                                  <path
                                    strokeLinecap="butt"
                                    strokeLinejoin="miter"
                                    fillOpacity={0}
                    ...
                    <span className="tabular-nums">
                      <number-flow-react
                        aria-label={9}
                        role="img"
                        data='{"pre":[],"integer":[{"type":"integer","value":9,"key":"integer:0","pos":0}],"fraction":[],"post":[],"valueAsString":"9","value":9}'
                      />
                    </span>
                  </button>
                </div>
              ...
              <div className="flex flex-col gap-4 mt-4">
                <div className="">
                  <div className="flex items-start justify-between pl-0">
                    <div className="flex w-full">
                        ...
                        <a href="/yogini">
                          <div className="w-8 h-8 relative">
                            ...
                            <div className="w-8 h-8 rounded-full overflow-hidden ">
                              <img
                                className="w-8 h-8 rounded-full bg-center bg-no-repeat bg-cover flex justify-center items-center object-cover hover:opacity-90 transition-opacity border-1  rounded-full bg-gray-00"
                      ...
                      <div className="ml-2 w-full">
                        <div className="flex items-center">
                          <span className="max-w-fit ">
                            <a href="/yogini">
                              <p className="text-gray-1k font-semibold text-sm hover:underline">
                                Yogini Bende
                              </p>
                            </a>
                          </span>
                          <span className="text-xxs text-gray-500 ml-2">
                            3h{" "}
                          </span>
                        </div>
                        <div>
                          <div>
                            <div
                              className="break-words text-gray-1k text-gray-1k text-sm rich-text-paragraph-regular link-break"
                              id="comment-body"
                            >
                              <p className="">
                                IMO, Targeted approach for everything!{" "}
                              </p>
                              <br />
                              <p className="">
                                When you are thinking of raising a round, there
                                is a lot more than just money. So consider
                                investor profiles very seriously, who can help
                                you
                                <span
                                  className="text-green-300 !font-normal hover:underline cursor-pointer ml-0.5"
                        ...
                        <div className="flex -ml-2 items-center gap-2 mt-1">
                          <button
                            className="flex py-0.5 px-2 rounded-md group hover:bg-gray-200"
                            type="button"
                          >
                            <p className="group-hover:!text-gray-1k text-gray-700 font-semibold text-[10px] leading-normal">
                              Like&nbsp;•&nbsp;1
                            </p>
                          </button>
                          <button
                            ...
                            type="button"
                          >
                            <p className="group-hover:text-gray-1k text-gray-700 leading-normal font-semibold text-[10px] ">
                              Reply
                            </p>
                          </button>
                          <div role="none">
                            ...
                            >
                              ...
                              <div className="" role="button" tabIndex={0}>
                                <button
                                  className="flex p-0.5 rounded-md group hover:bg-gray-200"
                                  type="button"
